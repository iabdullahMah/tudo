...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    #SOURCE: user input save in $message
    if ($message !== "") {
        #TAINT: The only check if it's not empty
        $t_file = fopen("../templates/motd.tpl", "w");
        fwrite($t_file, $message);
        #SINK: The none sanitize variable saved direct in the file.
        #VULN: SSTI using the $message ver
        fclose($t_file);
...
<body>
    ...
    <div id="content">
        <form class="center_form" action="update_motd.php" method="POST">
            ...
            <input type="submit" value="Update Message"> <?php if (isset($success)) {
