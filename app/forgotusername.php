...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    # SINK: User input used without any sanitization in a SQL query
    #VULN: SQLi verified with payload user1';SELECT PG_SLEEP(5)--
...
<body>
    ...
    <div id="content">
        <form class="center_form" action="forgotusername.php" method="POST">
            ...
            <?php if (isset($error)) {
                echo "<span style='color:red'>User doesn't exist.</span>";
            } else if (isset($success)) {
                echo "<span style='color:green'>User exists!</span>";
            } ?>
            <br><br>
